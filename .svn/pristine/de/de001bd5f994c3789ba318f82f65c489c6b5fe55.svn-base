                    ...
                    while ((length = input.available()) > 0) {
                        ...
                        if (sb2.toString().startsWith("ff0000")) {
                            ...
                            try {
                                ...
                                /**
                                 * 特殊情况：紫光捷通计重设备的删除指令识别以ff0000开头的信息，
                                 * 其他计重设备识别以ff0001开头的删除指令。 modify by yili
                                 * 2016/09/26
                                 */
                                String str = MyPropertiesUtils.getProperties(Constant.PROP_MTCLANE_FUNCTION, "unisPAT", "1");
                                switch (str) {
                                    case "0":
                                        write("主机发送删除命令", "FF0000015B82");//针对紫光捷通设备进行兼容支持
                                        break;
                                    case "1":
...
/*        String str = "ff00004d07e00a11093816000000000c0c006f006f006f006f006f006f006f006f006f006f006f006f01020202020202020101010101f401f401f401f401f401f401f401f401f401f401f4b00d";
        System.out.println(str.length());
        int cnt = 12;
        int i = 34 + cnt * 4 + cnt * 2 + (cnt - 1) * 4 + 4;
        System.out.println(i);*/
    	
    	String str = "ff000109abcdffff000109dbdagc";
    	int idx = str.indexOf("ff0001", 6);
