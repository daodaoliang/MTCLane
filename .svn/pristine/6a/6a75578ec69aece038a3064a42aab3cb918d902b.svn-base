...
public class EntryJFrame extends javax.swing.JFrame {
    ...
    private static EntryJFrame entryJFrame;
     ...
     * @return 唯一实例化对象
     */
    public static synchronized EntryJFrame getSingleInstance() {
        if (entryJFrame == null) {
            entryJFrame = new EntryJFrame();
        }
        return entryJFrame;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "请输入入口站", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("宋体", 1, 24))); // NOI18N
