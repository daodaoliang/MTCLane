...
public class Vehicle implements Serializable {
    ...
    // 轴组类型集合，以逗号分隔，例如01，02，03
    private String axleGroupStr;
    // 单轴轴重详细信息，单位吨，以逗号分隔，例如5.0，6.0，7.0
    private String axleWeightDetail;
    /**
     * 车牌黑白灰名单描述
     */
    ...
    public void setAxleGroupStr(String axleGroupStr) {
        this.axleGroupStr = axleGroupStr;
    }

    public String getAxleWeightDetail() {
        return axleWeightDetail;
    }

    public void setAxleWeightDetail(String axleWeightDetail) {
        this.axleWeightDetail = axleWeightDetail;
    }
