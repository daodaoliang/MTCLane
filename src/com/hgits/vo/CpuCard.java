...
public class CpuCard extends Card {
    ...
    private double balance;//余额,单位元，精确到小数点后两位有效数字
...
//    private long ibalance2;     //卡片消费后余额
    ...
    private String exitRoadId;//卡内记录的出口路段号
    private String exitStationId;//卡内记录的出口收费站号
...
//        this.ibalance2 = cpuCard.getIbalance2();
        ...
        this.exitRoadId = cpuCard.getExitRoadId();
        this.exitStationId = cpuCard.getExitStationId();
    ...
    public String getExitRoadId() {
        return exitRoadId;
    }

    public void setExitRoadId(String exitRoadId) {
        this.exitRoadId = exitRoadId;
    }
...
//    }
    ...
    public String toString() {
        return super.toString()+"CpuCard{" + "issuer=" + issuer + ", balance=" + balance + ", cardType=" + cardType + ", laneStatus=" + laneStatus + ", userType=" + userType + ", psamNum=" + psamNum + ", tacCode=" + tacCode + ", termCode=" + termCode + ", termTradNo=" + termTradNo + ", tradeNo=" + tradeNo + ", discount=" + discount + ", cpuNum=" + cpuNum + ", info19=" + info19 + ", info15=" + info15 + ", cardVersion=" + cardVersion + ", startDate=" + startDate + ", endDate=" + endDate + ", plateInCard15=" + plateInCard15 + ", plateInCard19=" + plateInCard19 + ", bindFlag=" + bindFlag + ", enJobNum=" + enJobNum + ", money=" + money + ", exitRoadId=" + exitRoadId + ", exitStationId=" + exitStationId + '}';
    }
