...
public class FileUtils extends org.apache.commons.io.FileUtils {
    ...
    private static String dataEncodeMode;
    
    /**
     * 获取编码格式
     * @return
     */
    public static String getDataEncodeMode() {
    	dataEncodeMode = MyPropertiesUtils.getProperties(Constant.PROP_MTCLANE_FUNCTION, "dataEncodeMode", "0");
		return dataEncodeMode;
	}
