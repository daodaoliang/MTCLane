...
import com.hgits.control.AvcControl;
...
import com.hgits.control.ServiceCardControl;
...
//            extJFrame.initVideo();
            ...
            m1Control.setKeyboard(keyboard);
            ServiceCardControl sc = ServiceCardControl.getSingleInstance();
            sc.setExtJFrame(extJFrame);
            sc.setM1Control(m1Control);
            /**
             * 生成车道版本信息
             */
            MTC mtc = new MTC();
            ...
            m1Control.setCartControl(cartControl);
...
//            ImgLaneClientControl imgLaneClientControl = new ImgLaneClientControl();
            ...
            LogControl.logInfo("加载国产化独立车型分类器控制");//by zengzb
            AvcControl avcControl = AvcControl.getAvcControl();
...
//            fc.setMireader(miReader);
            ...
            fc.setCc(cc);
            fc.setAvcControl(avcControl);//by zengzb
            mainSvc.setFc(fc);
...
//            QuartzManage.startJob("checkMultiParamJob", checkMultiParamTrigger, checkMultiParamJob, "0 */1 * * * ?");
            ...
            //开启定时器检查线程
            CheckQuartzTimeThread cqt = new CheckQuartzTimeThread(backUpLogTrigger, checkParamTrigger);
